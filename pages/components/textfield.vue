  ...
  <NuxtLayout name="custom">
    <div class="space-y-6 *:shadow">
      <section class="border p-3">
        <label>input</label>
        <fieldset
          class="relative mt-1.5 overflow-clip rounded after:absolute after:bottom-0 after:block after:w-full after:scale-x-0 after:border-b-2 after:border-blue-500 after:transition-transform after:content-[''] has-[input:focus]:after:scale-x-100"
        >
          <input
            type="text"
            class="block w-full rounded border px-1.5 py-0.5 outline-none"
          />
        </fieldset>
      </section>
      ...
      <div class="max-w-sm bg-white px-6 py-5 shadow">
        <form>
          <div>
            <label
              for="username"
        ...
        <form>
          <div>
            ...
            <div class="mt-1">
              ...
              />
              <p
                class="mt-2 text-sm text-slate-600 opacity-10 contrast-more:opacity-100"
              >
      ...
      <fieldset class="max-w-md bg-white p-8 text-sm shadow">
        <div
          class="mb-6 border-b border-slate-200 pb-2 text-base font-semibold"
        >
          Published status
        </div>
        <input
          id="draft"
          class="peer/draft form-radio mb-0.5 mr-2 border-slate-300 text-sky-400 focus:ring-sky-300"
          type="radio"
          name="status"
          checked
        ...
        <input
          id="published"
          class="peer/published form-radio mb-0.5 ml-4 mr-2 border-slate-300 text-sky-400 focus:ring-sky-300"
          type="radio"
          name="status"
        /><label
          ...
          >Published</label
        >
        <div class="mt-4 hidden text-gray-500 peer-checked/draft:block">
          Drafts are only visible to administrators.
        </div>
        <div class="mt-4 hidden text-gray-500 peer-checked/published:block">
      ...
      <div class="max-w-md bg-white px-4 py-6 shadow">
        <fieldset>
          ...
          <div class="mt-4 space-y-2">
            <label
              for="apple"
              class="grid grid-cols-[24px_1fr_auto] items-center gap-6 rounded-lg p-4 text-slate-700 ring-1 ring-transparent hover:bg-slate-100 has-[:checked]:bg-indigo-50 has-[:checked]:text-indigo-900 has-[:checked]:ring-indigo-200"
            >
            ...
            <label
              for="google"
              class="grid grid-cols-[24px_1fr_auto] items-center gap-6 rounded-lg p-4 text-slate-700 ring-1 ring-transparent hover:bg-slate-100 has-[:checked]:bg-indigo-50 has-[:checked]:text-indigo-800 has-[:checked]:ring-indigo-200"
            >
              <svg
                class="mt-1 w-8 fill-current"
                fill="currentColor"
                viewBox="0 0 24 13"
              >
                <path
